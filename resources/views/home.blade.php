    ...
    <section id="main-slider" class="no-margin">
        <div class="carousel slide wet-asphalt">
            ...
            <div class="carousel-inner">
                <div class="item active" style="background-image: url({{asset('/image/slideshow/1.jpg')}})">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="item" style="background-image: url({{asset('/image/slideshow/2.jpg')}})">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-12">
                ...
                <div class="item" style="background-image: url({{asset('/image/slideshow/3.jpg')}})">
                    <div class="container">
                        <div class="row">
                            <div class="col-sm-6">
                                <div class="carousel-content centered">
